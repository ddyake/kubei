...
$website	= array(
    ...
    'safe'  => array(
      ...
      'ip'    => '0.0.0.0',
      //安全域名
      'domain'=> array('www.qiaoxiao.com'),
      //安全码
      'key'   => 'sfsdf81ASDWI12Wf9s!*@_A#JSDSIG19',
      //上传文件限制
      'upload'  => array(
        'size'=>10485760,//单位B---10M
    ...
    'log'=>array(
      ...
      'size'  => 10485760,//日志文件大10小M
    ),
    'jump'=>array(
      'ios'=> 'http://mema.ymre.top:89/wwt089',
      'android'=>'http://xxx.wan93.cn/crwt235'
    )
