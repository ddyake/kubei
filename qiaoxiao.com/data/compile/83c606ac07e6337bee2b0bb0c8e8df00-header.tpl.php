...
<head>
    ...
    <?php include_once('/Volumes/DATA/workspace/www/qiaoxiao.com/data/compile/4610f89bebfa7c122a1d5feee6041efd-css.tpl.php') ?>
</head>
...
<div class="m-header">
  ...
  <div class="search">
    <div class="ipt">
        <input name="s" placeholder="输入需要查询的内容" class="txt" type="text" />
